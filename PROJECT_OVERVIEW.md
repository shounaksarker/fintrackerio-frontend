...
| 2026-03-14 | Fix: SQL escaping in `encryptData()` utility      | `utils/security.js` — escape `\`, `"`, `'` in user input before AES_ENCRYPT interpolation; fixes edit operations breaking on apostrophes                                                   |
